...
import { change2FASchema } from '../../schemas/schemas';
const jwtSecret = process.env.JWT_SECRET;

export default async function changeUser2FA(formData) {
  ...
  const zodValidationResults = change2FASchema.safeParse(formData);
  ...
  try {
    const { userId, enable2FA } = zodData;
